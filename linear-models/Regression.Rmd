...
It's doing better than our simple model, getting the R^2 up much more and a lower RSE. 
...
So, in the end, the combination of interaction effects and multiple regression provided the best trends. Simple regression 
